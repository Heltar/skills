...
| [heltar-web-widget](./skills/heltar-web-widget/SKILL.md)         | Embed the web chat widget on your site                           |
| [heltar-business](./skills/heltar-business/SKILL.md)             | Account status, opt-in / opt-out rules, business settings        |
| [heltar-team](./skills/heltar-team/SKILL.md)                     | Team members, roles, business access, chat assignment            |
| [heltar-analytics](./skills/heltar-analytics/SKILL.md)           | Engagement, conversation, template and cost analytics            |
| [heltar-link-tracker](./skills/heltar-link-tracker/SKILL.md)     | Short, trackable links                                           |
